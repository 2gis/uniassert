...
#define PRIVATE_UNI_CHECK_THROW_CHOOSER(...) \
	PRIVATE_UNI_EXPAND(PRIVATE_UNI_GET_4TH_ARG(__VA_ARGS__, PRIVATE_UNI_CHECK_THROW_TYPE, PRIVATE_UNI_CHECK_THROW, NONSENSE))
...
#define PRIVATE_UNI_CHECK_RETURN_CHOOSER(...) \
	PRIVATE_UNI_EXPAND(PRIVATE_UNI_GET_3TH_ARG(__VA_ARGS__, PRIVATE_UNI_CHECK_RETURN_VALUE, PRIVATE_UNI_CHECK_RETURN, NONSENSE))
